...
export default [
    ...
    {
        name   : 'app/directives-and-composables-files-to-lint',
        files  : ['src/directives/*.ts', 'src/directives/**/*.ts', 'src/composables/*.ts', 'src/composables/**/*.ts'],
        plugins: {
